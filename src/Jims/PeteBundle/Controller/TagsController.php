...
use Jims\PeteBundle\Entity\Tags;
use Jims\PeteBundle\Form\TagsType;
...
class TagsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('JimsPeteBundle:Tags')->findAll();

        return $this->render('JimsPeteBundle:Tags:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('JimsPeteBundle:Tags:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('JimsPeteBundle:Tags')->find($id);
        ...
        return $this->render('JimsPeteBundle:Tags:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('JimsPeteBundle:Tags:edit.html.twig', array(
            'entity'      => $entity,
